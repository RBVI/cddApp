...
public class DomainTable extends JTable {
	...
	final static String[] columnNames = {"Domain","Type","Location"};
	final DomainTableModel tableModel;
	final JTable table;

	public DomainTable(CyIdentifiable cyId, CDDDomainManager manager) {
		super(new DomainTableModel(cyId, manager, columnNames, null));
